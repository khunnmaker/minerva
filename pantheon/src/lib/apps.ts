...
export const APPS: AppDef[] = [
  ...
  },
  {
    key: 'mali',
    name: 'Mali',
    job: 'คลังความรู้ทีมงาน',
    // Hidden until the mali service + domain are live: no default URL, so the tile
    // only appears once VITE_MALI_URL is set (flip to a domain default at launch).
    url: env.VITE_MALI_URL || '',
...
const ORDER: AppKey[] = ['juno', 'apollo', 'jupiter', 'minerva', 'venus', 'vesta', 'ceres', 'mercury', 'mali'];
